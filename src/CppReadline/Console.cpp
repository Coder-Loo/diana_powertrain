// Created by https://github.com/Svalorzen/cpp-readline
...
namespace CppReadline {
    ...
    void Console::registerDefaultCommand(CommandFunction f) {
        defaultCommand_ = f;
    }
    ...
    int Console::executeCommand(const std::string & command) {
        ...
        if(defaultCommand_ != nullptr) {
          return defaultCommand_(inputs);
        } else {
